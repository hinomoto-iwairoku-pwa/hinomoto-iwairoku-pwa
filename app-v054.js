const STORAGE_KEY = "hinomoto_pwa_state_v54";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.54.0-tagged-response-format";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=054"); }
