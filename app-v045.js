const STORAGE_KEY = "hinomoto_pwa_state_v45";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.45.0-document-action-fixed";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=045"); }
