const STORAGE_KEY = "hinomoto_pwa_state_v30";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.30.0-reader-mode";
...
function renderLatestResponse() {
  ...
  if (readerText) readerText.textContent = text;
  if (isAdopted) {
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=030"); }
