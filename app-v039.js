const STORAGE_KEY = "hinomoto_pwa_state_v39";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.39.0-reading-priority";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=039"); }
