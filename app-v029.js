const STORAGE_KEY = "hinomoto_pwa_state_v29";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.29.0-response-preview";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=029"); }
