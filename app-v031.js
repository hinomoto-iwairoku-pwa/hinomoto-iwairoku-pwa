const STORAGE_KEY = "hinomoto_pwa_state_v31";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.31.0-parse-response";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=031"); }
