const STORAGE_KEY = "hinomoto_pwa_state_v56";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.56.0-return-to-play-on-send";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=056"); }
