const STORAGE_KEY = "hinomoto_pwa_state_v34";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.34.0-large-inline-reader";
...
function setupEvents() {
  ...
  $("readerAdoptButton").addEventListener("click", adoptResponse);
  $("readerJumpButton").addEventListener("click", () => {
    closeReader();
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=034"); }
