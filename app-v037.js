const STORAGE_KEY = "hinomoto_pwa_state_v37";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.37.0-contained-text-scroll";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=037"); }
