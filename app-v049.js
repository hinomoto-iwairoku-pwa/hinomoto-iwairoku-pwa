const STORAGE_KEY = "hinomoto_pwa_state_v49";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.49.0-candidates-inside-text";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=049"); }
