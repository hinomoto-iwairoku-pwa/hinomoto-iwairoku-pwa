const STORAGE_KEY = "hinomoto_pwa_state_v52";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.52.0-adopt-gate-on-click";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=052"); }
