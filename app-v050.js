const STORAGE_KEY = "hinomoto_pwa_state_v50";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.50.0-backup-during-review";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=050"); }
