const STORAGE_KEY = "hinomoto_pwa_state_v41";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.41.0-large-inline-default";
...
function setupEvents() {
  ...
  if ($("closeReaderButton")) if ($("closeReaderButton")) if ($("closeReaderButton")) $("closeReaderButton").addEventListener("click", closeReader);
  if ($("readerAdoptButton")) if ($("readerAdoptButton")) if ($("readerAdoptButton")) $("readerAdoptButton").addEventListener("click", adoptResponse);
  if ($("readerJumpButton")) if ($("readerJumpButton")) if ($("readerJumpButton")) $("readerJumpButton").addEventListener("click", () => {
    closeReader();
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=041"); }
