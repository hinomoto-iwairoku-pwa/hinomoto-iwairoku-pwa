const STORAGE_KEY = "hinomoto_pwa_state_v44";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.44.0-document-action-flow";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=044"); }
