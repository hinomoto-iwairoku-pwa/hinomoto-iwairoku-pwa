const STORAGE_KEY = "hinomoto_pwa_state_v32";
...
function normalizeState() {
  ...
  appState.meta.appVersion = "0.32.0-next-action-flow";
...
async function registerServiceWorker() {
  if ("serviceWorker" in navigator) {
    try { await navigator.serviceWorker.register("./service-worker.js?v=032"); }
